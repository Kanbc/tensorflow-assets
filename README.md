...
##### Unsupervised
- **Auto-Encoder** ([notebook](https://github.com/Kanbc/tensorflow-assets/blob/master/notebook/neural_networks/autoencoder.ipynb)) Build an auto-encoder to encode an image to a lower dimension and re-construct it.
